        ...
        when (credential) {
            is Holder.StoreCredentialInput.Vc -> {
                ...
                subjectCredentialStore.storeCredential(
                    ...
                    issuer = credential.signedVcJws.header.certificateChain?.leaf?.encodeToDerOrNull()
                )
            }
            ...
            is Holder.StoreCredentialInput.SdJwt -> {
                ...
                subjectCredentialStore.storeCredential(
                    ...
                    scheme = credential.scheme,
                    renewalInfo = renewalInfo,
                    issuer = credential.signedSdJwtVc.jws.header.certificateChain?.leaf?.encodeToDerOrNull()
                )
            }
